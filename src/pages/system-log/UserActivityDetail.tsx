        ...
        <Container>
          <Toolbar>
            <ToolbarHeading>
              <ToolbarPageTitle />
              <ToolbarDescription>
                View complete activity history for a specific user.
              </ToolbarDescription>
            </ToolbarHeading>
            <ToolbarActions>
              ...
              <button onClick={() => navigate('/system-log')} className="btn btn-sm btn-light">
                Back to Logs
              </button>
              ...
              <button onClick={() => setShowSuspendModal(true)} className="btn btn-sm btn-warning">
                Suspend User
              </button>
              ...
              <button onClick={() => setShowBlockModal(true)} className="btn btn-sm btn-danger">
                Block User
              </button>
            </ToolbarActions>
          </Toolbar>
