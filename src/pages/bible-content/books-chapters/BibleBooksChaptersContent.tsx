                  ...
                  <div className="border-t bg-gray-50 dark:bg-coal-100 p-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
                      {chapters
                        ...
                        .map((chapter) => (
                          <div key={chapter.id} className="border border-gray-200 dark:border-gray-700 rounded-lg p-3 bg-white dark:bg-coal-200">
                            ...
                            <p className="text-sm text-gray-600 dark:text-gray-400 mb-2">{chapter.verses} verses</p>
