...
import { Shield, Lock, Eye, Save, TestTube, RefreshCw } from 'lucide-react';
      ...
      <CardContent className="space-y-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="space-y-2">
            ...
            <Input id="password_min_length" type="number" placeholder="8" defaultValue="8" />
          </div>
          ...
          <div className="space-y-2">
            ...
            <Input id="max_login_attempts" type="number" placeholder="5" defaultValue="5" />
          </div>

          <div className="space-y-2">
            <Label htmlFor="lockout_duration">Lockout Duration (minutes)</Label>
            <Input id="lockout_duration" type="number" placeholder="15" defaultValue="15" />
          </div>
        </div>
